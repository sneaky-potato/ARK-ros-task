...
def start_node(filepath):
    ...
    for i in range(10):
        ...
        extrinsic = np.hstack([R.T, -R.T.dot(tvec)])
        ...
        intrinsic = np.matrix([[f_x, 0, c_x], [0, f_y, c_y], [0, 0, 1]])

        projection = intrinsic.dot(extrinsic)
        print(projection)
...
if __name__ == '__main__':
    ...
    except rospy.ROSInterruptException or IndexError:
        print("Usage: roscore [package_name] [node] [filepath]")
        pass